...
def main():
    ...
    for i, N in enumerate(N_values):
        ...
        source_point, source_node = solver.Innit_Origin_Point(source_coord, node_list)
        ...
        # Error Computation
        err_fmm, err_rel_fmm, e_l2_fmm = solver.compute_err(node_list,source_coord)
        ...
        solver.Reset_Node_State(node_list, source_nodes, source_coord)
        ...
        # Error Computation
        err_circ, err_rel_circ, e_l2_circ = solver.compute_err(node_list, source_coord)
